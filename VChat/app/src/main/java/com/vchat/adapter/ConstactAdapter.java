...
import com.vchat.R;
import com.vchat.bean.Child;
import com.vchat.bean.Group;
import com.vchat.view.CircleImageView;
import com.vchat.view.IphoneTreeView;
import com.vchat.view.IphoneTreeView.IphoneTreeHeaderAdapter;
...
public class ConstactAdapter extends BaseExpandableListAdapter implements
	...
	public View getChildView(int groupPosition, int childPosition,boolean isLastChild, View convertView, ViewGroup parent) {
		...
		Log.d("test", child.getMood());
		System.out.print(child.getMood());
		holder.feelView.setText(child.getMood());    //ConstactFragment -158
		return convertView;
	}
