...
import com.vchat.activity.LoginActivity;
import com.vchat.db.ChatMsgDao;
import com.vchat.fragment.ConstactFragment;
import com.vchat.fragment.NewsFragment;
import com.vchat.fragment.SettingFragment;
...
//		XmppUtil.getAllEntries(XmppConnectionManager.getInstance().init().getRoster());
