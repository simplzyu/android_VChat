...
import com.vchat.listener.CheckConnectionListener;
import com.vchat.listener.FriendsPacketListener;
import com.vchat.listener.MsgListener;
...
//			SmackAndroid.init(this);
			...
			if(mXMPPConnection.isAuthenticated()){                                     //登录成功
				WeChatApplication.xmppConnection=mXMPPConnection;
