...
import com.vchat.R;
import com.vchat.activity.AddFriendActivity;
import com.vchat.activity.ChatActivity;
import com.vchat.adapter.ConstactAdapter;
...
public class ConstactFragment extends Fragment {
	...
	public void findFriends() {
		try {
			...
			XMPPConnection conn = WeChatApplication.xmppConnection;
...
//							child.setMood("wechat");  //设置mood
							if("1".equals(child.getOnline_status())){
								child.setMood("在线");
							}else{
								child.setMood("离线");
							}
