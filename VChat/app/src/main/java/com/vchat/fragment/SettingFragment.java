...
import com.vchat.activity.MsgAlertActivity;
import com.vchat.activity.MsgHistroyActivity;
import com.vchat.activity.SignActivity;
		...
		case R.id.online_status:
			...
			bd.setItems(items, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface arg0, int arg1) {
					XMPPConnection mXMPPConnection= WeChatApplication.xmppConnection;
